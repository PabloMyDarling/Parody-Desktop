...
linktree_button.bind("<Enter>", lambda e: mb_hovered(linktree_button, "Visit my website!"))
linktree_button.bind("<Leave>", lambda e: mb_left(linktree_button))
linktree_button.bind("<Button-1>", lambda e: open_new_tab("https://pablomydarling.github.io/"))
